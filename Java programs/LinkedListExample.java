...
Student s1=new Student("Animesh", 20, 79);
Student s2=new Student("Binay", 20, 90);
Student s3=new Student("Arpitam", 20, 95);
list.add(s1);
list.add(s2);
list.add(s3);
        ...
        System.out.println("The student exists in thelist.");
        } else {
        System.out.println("The student does not exist inthe list.");
        }
        }
        break;
        ...
        System.out.println("The student has been removedfrom the list.");
        } else {
        System.out.println("The student does not exist inthe list.");
        }
        }
        break;
        case 4:
        System.out.println("The number of students in the listis " + list.size() + ".");
        break;
        case 5:
